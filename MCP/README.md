# ContainerRegistryManagementClient MCP Server

This MCP (Model Content Protocol) server provides access to ContainerRegistryManagementClient API functionality through HTTP, HTTPS, and STDIO transport modes.
