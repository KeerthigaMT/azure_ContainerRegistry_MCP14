...
func Replications_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplications_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft.ContainerRegistry_registries_registryName_replications_replicationName",
		mcp.WithDescription("Gets the properties of the specified replication."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replications_getHandler(cfg),
	}
}
