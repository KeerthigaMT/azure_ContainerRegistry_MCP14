...
func Registries_listbyresourcegroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ContainerRegistry/registries%s", cfg.BaseURL, subscriptionId, resourceGroupName, queryString)
...
func CreateRegistries_listbyresourcegroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft.ContainerRegistry_registries",
		mcp.WithDescription("Lists all the container registries under the specified resource group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Registries_listbyresourcegroupHandler(cfg),
	}
}
