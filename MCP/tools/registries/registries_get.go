...
func Registries_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRegistries_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft.ContainerRegistry_registries_registryName",
		mcp.WithDescription("Gets the properties of the specified container registry."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Registries_getHandler(cfg),
	}
}
