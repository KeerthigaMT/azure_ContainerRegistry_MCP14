...
func Registries_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/providers/Microsoft.ContainerRegistry/registries%s", cfg.BaseURL, subscriptionId, queryString)
...
func CreateRegistries_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_providers_Microsoft.ContainerRegistry_registries",
		mcp.WithDescription("Lists all the container registries under the specified subscription."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Registries_listHandler(cfg),
	}
}
